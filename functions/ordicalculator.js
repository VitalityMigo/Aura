...
async function ordiProfit(slug, wallet, time) {
    ...
    const prettier = {
        mintValue: parseFloat(data.mintValue).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.mintValue * btcPrice).toFixed(0)) + "$)",
        mintGas: parseFloat(data.mintGas).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.mintGas * btcPrice).toFixed(0)) + "$)",
        mintTotal: parseFloat(data.mintTotal).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.mintTotal * btcPrice).toFixed(0)) + "$)",
        buyValue: parseFloat(data.buyValue).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.buyValue * btcPrice).toFixed(0)) + "$)",
        buyGas: parseFloat(data.buyGas).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.buyGas * btcPrice).toFixed(0)) + "$)",
        buyTotal: parseFloat(data.buyTotal).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.buyTotal * btcPrice).toFixed(0)) + "$)",
        sellValue: parseFloat(data.sellValue).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.sellValue * btcPrice).toFixed(0)) + "$)",
        sellGas: parseFloat(data.sellGas).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.sellGas * btcPrice).toFixed(0)) + "$)",
        sellTotal: parseFloat(data.sellTotal).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.sellTotal * btcPrice).toFixed(0)) + "$)",
        ...
        avgMint: parseFloat(data.avgMint).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.avgMint * btcPrice).toFixed(0)) + "$)",
        avgBuy: parseFloat(data.avgBuy).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.avgBuy * btcPrice).toFixed(0)) + "$)",
        avgTotal: parseFloat(data.avgTotal).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.avgTotal * btcPrice).toFixed(0)) + "$)",
        avgSold: parseFloat(data.avgSold).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.avgSold * btcPrice).toFixed(0)) + "$)",
        avgHeld: parseFloat(data.avgHeld).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.avgHeld * btcPrice).toFixed(0)) + "$)",
        avgGas: parseFloat(data.avgGas).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.avgGas * btcPrice).toFixed(0)) + "$)",
        realisedPNL: parseFloat(data.realisedPNL).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.realisedPNL * btcPrice).toFixed(0)) + "$)",
        potentialPNL: parseFloat(data.potentialPNL).toFixed(3) + "Ξ (" + new Intl.NumberFormat('en-US').format(parseFloat(data.potentialPNL * btcPrice).toFixed(0)) + "$)",
