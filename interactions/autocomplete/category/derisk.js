...
const { wallets, apimonitorsql, adminsql, reportsql, sequelize } = require('../../../events/database');
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const selectedWallet = interaction.options.get("wallet");
            ...
            let reportCommand = "/derisk-autocomplete"
