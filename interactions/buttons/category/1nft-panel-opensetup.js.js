...
const { profileData, accessSql, apimonitorsql, wallets, reportsql, adminsql, infra_nft, infra_friendTech, sequelize } = require('../../../events/database');
...
module.exports = {
    id: 'button_nft_tradepanel_setup',
