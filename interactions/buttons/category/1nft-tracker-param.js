...
const { accessSql, profileData, adminsql, reportsql, tracker_nft, sequelize } = require('../../../events/database');
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const match = customId.match(/button_nft_infra_tracker_(.+)/);
                ...
                if (match && match[1]) {
                    ...
                    if (action === "add") {
                        ...
                        const passwordAdminDashboard = new ModalBuilder()
                            .setCustomId('modal_nft_infra_tracker_add')
                        ...
                        const channel = new TextInputBuilder()
                            .setCustomId('modal_nft_infra_tracker_addR1')
                            .setLabel("Address(es)")
                        ...
                        const passwordAdminDashboard = new ModalBuilder()
                            .setCustomId('modal_nft_infra_tracker_remove')
                        ...
                        // Create the text input components
                        const channel = new TextInputBuilder()
                            .setCustomId('modal_nft_infra_tracker_removeR1')
                            .setLabel("Address")
                            .setPlaceholder("0x...")
                        ...
                        await tracker_nft.destroy({ where: { authorId: authorId } })
                        ...
                        await interaction.update({ embeds: [botOff], components: [buttonsRow] });
