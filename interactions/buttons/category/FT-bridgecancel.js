...
const { accessSql, profileData, adminsql, reportsql, exe_friendTech, sequelize } = require('../../../events/database');
...
module.exports = {
    id: 'friendtech_exec_bridgecancel',
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const gasTrackerEmbed2 = new EmbedBuilder().setColor("#060A8F")
                ...
                .addFields(
                    { name: " ", value: " ", inline: false },
                    { name: "Task Cancelled ✅", value: "Your task has been successfully cancelled , you can recreate a new one from the different Friend.Tech panel", inline: false },
            ...
            let reportCommand = "/FT-bridgecancel"
