...
module.exports = {
    id: 'button_friendtech_exec_sell_',
        ...
        try {
            ...
            console.log("// Step 1 : Initialization - Executed ✅")
                ...
                if (matches && matches[1]) {
                    ...
                    .setCustomId('modal_friendtech_exec_sell_' + subject)
                ...
                const channel = new TextInputBuilder()
                    .setCustomId('modal_friendtech_exec_sell_' + subject + "_amountR1")
                    .setLabel("Share Amount")
                    .setPlaceholder("The amount of share to sell")
