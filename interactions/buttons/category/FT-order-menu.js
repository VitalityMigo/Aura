        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const errorNotEthereum = new EmbedBuilder().setColor("#060A8F")
                    ...
                    .setDescription(">>> Displaying your Friend.Tech order tasks")
                    //  .setThumbnail('https://cdn.discordapp.com/attachments/1108757847208099941/1133190291428479016/image.png')
                    .setAuthor({ name: authorName, iconURL: userAvatar })
                    .addFields(
                        { name: " ", value: " ", inline: false },
                        { name: " ", value: "The order tasks are being built at the moment, and will be available soon. Come back soon !", inline: false },
