...
module.exports = {
    id: 'friendtechtasksinfra-snipercreatenewuser-button',
                    ...
                    if (snipeTasksCount < 5) {
                        ...
                        const buttonsRow2 = new ActionRowBuilder()
                            .addComponents(
                                ...
                                new ButtonBuilder()
                                    .setCustomId('button-friendtechtasksinfra-sniper-param-followers@' + randomId)
                                    .setLabel('Set Followers')
                                    .setStyle(2),
                                new ButtonBuilder()
                        ...
                        const buttonsRow3 = new ActionRowBuilder()
                            .addComponents(
                                ...
                                new ButtonBuilder()
                                    ...
                                    .setStyle(4),
                                new ButtonBuilder()
                                    .setCustomId('friendtechtasksinfra-sniperusertutorial-button')
                                    .setLabel('📑 Tutorial')
                                    .setStyle(1),
                                new ButtonBuilder()
                        ...
                        const errorNotEthereum = new EmbedBuilder().setColor("#060A8F")
                            ...
                            .setDescription(">>> New user snipe settings")
                            ...
                            .addFields(
                                ...
                                { name: " ", value: " ", inline: false },
                                { name: "Min. Followers", value: "`Any`", inline: true },
                                { name: "Max. Followers", value: "`Any`", inline: true },
                                { name: " ", value: " ", inline: false },
