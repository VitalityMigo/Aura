        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                if (botGlobalState.toLowerCase() === "on") {
                    ...
                    await adminsql.update({ botState: "off", }, { where: { botId: botId } })
                    await accessSql.update({ actualPower: "off", }, { where: {} })
                    ...
                    const errorturnPrivateModeEmbed = new EmbedBuilder().setColor("#060A8F")
                        .setTitle("Admin Dashboard")
                        .setDescription("An error has occurred while retrieving the community settings. Please contact the bot administrator to investigate the problem.")
                        .setAuthor({ name: authorName, iconURL: userAvatar })
                        .setTimestamp()
                        .setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
