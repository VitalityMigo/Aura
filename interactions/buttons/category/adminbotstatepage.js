...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                if (botGlobalState.toLowerCase() === "on") {
                    ...
                    const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                        ...
                        .setDescription(">>> Modify the global power state of the bot")
                        ...
                        .addFields(
                            ...
                            { name: " ", value: " ", inline: false },
                            { name: "Statut", value: "The bot is in `available mode 🟢`", inline: false },
                            { name: " ", value: " ", inline: false },
                ...
                } else if (botGlobalState.toLowerCase() === "off") {
                    ...
                    const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                        ...
                        .addFields(
                            ...
                            { name: "Power Mecanism", value: "The power state is what allows the bot's admins to switch the bot's global statut to on or off. You can change the bot statut by using the button below.", inline: true },
                            { name: " ", value: " ", inline: false },
                            { name: "Statut", value: "The bot is in `sleep mode 🔴`", inline: false },
                            { name: " ", value: " ", inline: false },
            ...
            let reportCommand = "/admin-botStatePage"
