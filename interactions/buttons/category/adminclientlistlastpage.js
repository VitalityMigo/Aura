...
module.exports = {
    id: 'adminClientListLastPage-button',
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const indexTable = pageIndex - 2

                let serverName = reportTable[indexTable].serverName
                let serverID = reportTable[indexTable].serverId
                let accessTier = reportTable[indexTable].accessTier
                let adminRoleId = reportTable[indexTable].adminRoleId
                let memberRoleId = reportTable[indexTable].memberRoleId
                let updateChannel = reportTable[indexTable].updateChannel
                let accessSince = reportTable[indexTable].accessSince
                let adminWalletAddress = reportTable[indexTable].adminWalletAddress
                let actualPower = reportTable[indexTable].actualPower
                let password = reportTable[indexTable].password
                ...
                await interactionData.update({ actualPage: pageIndex, }, { where: { commandName: "adminclient-list", authorId: authorId, serverId: serverId } })
                ...
                const adminDashboardMainEmbed = new EmbedBuilder().setColor("#060A8F")
                    ...
                    .addFields(
                        ...
                        { name: 'Client Status', value: "`" + accessStatut + "`", inline: true },
            ...
            let reportCommand = "/admin-clientListLastPage"
