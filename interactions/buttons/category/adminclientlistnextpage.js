...
module.exports = {
    id: 'adminClientListNextPage-button',
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                if (pageIndex >= actualPage) {
                    ...
                    await interactionData.update({ actualPage: pageIndex.toString(), }, { where: { commandName: "adminclient-list", authorId: authorId, serverId: serverId } })
            ...
            let reportCommand = "/admin-clientListNextPage"
