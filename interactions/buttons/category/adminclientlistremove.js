...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                if (subscribtionStatut.toLowerCase() !== "lifetime") {
                    ...
                    if (parseInt(subscribtionStatut) <= 0) {
                        ...
                        subscribtionStatutFormatted = subscribtionStatut + "dayslate"
                ...
                reportTable[actualPageIndex].statut = "Removed"
                let accessStatutFormatted = "Removed 🔴"

                await interactionData.update({ embed1: JSON.stringify(reportTable), }, { where: { commandName: "adminclient-list", authorId: authorId, serverId: serverId } })
                await accessSql.destroy({ where: { serverID: serverID, adminRoleId: adminRoleId, memberRoleId: memberRoleId, accessSince: accessSince } })
            ...
            let reportCommand = "/admin-clientListRemove"
