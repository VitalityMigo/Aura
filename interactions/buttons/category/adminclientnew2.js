        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const passwordAdminDashboard = new ModalBuilder()
                    .setCustomId('adminClientNewModal2')
                    .setTitle('New Client');
                ...
                const channel = new TextInputBuilder()
                    ...
                    .setPlaceholder("The ID of the community's admin role")
                    .setStyle(TextInputStyle.Short)
                    .setMaxLength(40)

                // Create the text input components
                const channel2 = new TextInputBuilder()
                    .setCustomId('newClientAdminDashboardChangeR6')
                    .setLabel("Member Role ID")
                    .setPlaceholder("The ID of the community's member role")
                    .setStyle(TextInputStyle.Short)
                    .setMaxLength(40)

                // Create the text input components
                const channel3 = new TextInputBuilder()
                    .setCustomId('newClientAdminDashboardChangeR7')
                    .setLabel("Update Channel ID")
                    .setPlaceholder("The ID of the community's update channel")
                    .setStyle(TextInputStyle.Short)
                    .setMaxLength(40)
                ...
                passwordAdminDashboard.addComponents(firstActionRowSetProfile, secondActionRowSetProfile, thirdActionRowSetProfile, fourthActionRowSetProfile)
