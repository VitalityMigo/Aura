...
const buttonRowAdminDashboard = new ActionRowBuilder()
    .addComponents(
        new ButtonBuilder()
            .setCustomId('adminDataAPI-button')
            .setLabel('api')
            .setStyle(2),
        new ButtonBuilder()
            .setCustomId('adminDataUsers-button')
            .setLabel('users')
            .setStyle(2),
        new ButtonBuilder()
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                    ...
                    .setDescription(">>> Consult various data reports of the bot")
            ...
            let reportCommand = "/admin-datapage"
