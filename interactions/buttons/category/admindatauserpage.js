...
const { accessSql, profileData, apimonitorsql, apiproviderssql, usersql, adminsql, reportsql, sequelize } = require('../../../events/database');
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            let reportCommand = "/admin-datauserspage"
