...
module.exports = {
    id: 'adminDataUserPrevMonth-button',
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const usersLastMonth = await interactionData.findOne({ where: { authorId: "bot", commandName: "intervalUserMonth", serverId: "bot" } })

                if (usersLastMonth !== null) {

                    const lastMonthReportApi = JSON.parse(usersLastMonth.dataValues.embed1)
                    ...
                    const apiMonthlyReport = new EmbedBuilder().setColor("#060A8F")
                        ...
                        .addFields(
                            ...
                            { name: " ", value: " ", inline: false },
                            { name: " ", value: " ", inline: false },
                            { name: " ", value: "The last month's user report isn't available ❌.", inline: false },
            ...
            let reportCommand = "/admin-dataUserPrevMonth"
