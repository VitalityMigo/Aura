    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                let reportAuthorId = reportTable[indexTable].authorId
                let reportserverName = reportTable[indexTable].serverName
                let reportauthorRole = reportTable[indexTable].authorRole
                let reportserverId = reportTable[indexTable].serverId
                let reportdate = reportTable[indexTable].date
                let reportreportType = reportTable[indexTable].reportType
                let reportreportCommand = reportTable[indexTable].reportCommand
                let reportreportDescription = reportTable[indexTable].reportDescription
                let reportreportPriority = reportTable[indexTable].reportPriority
                let reportreportState = reportTable[indexTable].reportState
                ...
                await interactionData.update({ actualPage: pageIndex, }, { where: { commandName: "admin-report", authorId: authorId, serverId: serverId } })
            ...
            let reportCommand = "/admin-reportLastPage"
