    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            if (1 < actualPage) {
                ...
                await interactionData.update({ actualPage: "1", }, { where: { commandName: "admin-report", authorId: authorId, serverId: serverId } })
        ...
        let reportCommand = "/admin-reportPreviousPage"
