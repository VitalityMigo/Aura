...
module.exports = {
    id: 'RCDashboardReportByCommand-button',
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            reportTable.sort(function (a, b) {
                if (a.reportCommand < b.reportCommand) {
                    return -1;
                } else if (a.reportCommand > b.reportCommand) {
                    return 1;
                } else {
                    if (a.reportPriority < b.reportPriority) {
                        return -1;
                    } else if (a.reportPriority > b.reportPriority) {
                        return 1;
                    } else {
                        return 0;
                    }
            ...
            const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                ...
                .addFields(
                    ...
                    { name: "Report Filter", value: "`By date`", inline: true },
        ...
        let reportCommand = "/admin-reportByCommand"
