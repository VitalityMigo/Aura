...
module.exports = {
    id: 'RCDashboardReportByPriority-button',
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            reportTable.sort(function (a, b) {
                return b.reportPriority - a.reportPriority;
            });
            ...
            const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                ...
                .addFields(
                    ...
                    { name: "Report Filter", value: "`By priority`", inline: true },
        ...
        let reportCommand = "/admin-reportByPriority"
