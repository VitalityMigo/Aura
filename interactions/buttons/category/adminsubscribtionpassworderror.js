...
module.exports = {
    id: 'teamSubCancelSubPasswordTryAgain-button',
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            const passwordrcDashboard = new ModalBuilder()
                .setCustomId('teamSubCancelSubModal')
                .setTitle("Cancel Subscribtion");


            // Create the text input components
            const password = new TextInputBuilder()
                .setCustomId('teamSubCancelSubModalR1')
                .setLabel("Password")
                .setPlaceholder("The team's password")
        ...
        let reportCommand = "/admin-subscribtionPasswordError"
