    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            const passwordrcDashboard = new ModalBuilder()
                .setCustomId('teamSubModifyWallet')
                .setTitle("Modify Wallet");

            // Add components to modal

            // Create the text input components
            const wallet = new TextInputBuilder()
                .setCustomId('teamSubModifyWalletR1')
                .setLabel("New Team's Wallet")
                .setPlaceholder("The team's wallet you want to set up")
            ...
            const firstActionRowSetProfile = new ActionRowBuilder().addComponents(wallet);


            // Add inputs to the modal
            passwordrcDashboard.addComponents(firstActionRowSetProfile);
        ...
        let reportCommand = "/admin-subscribtionWalletChange"
