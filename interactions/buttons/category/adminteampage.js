...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            const mainRoleId = botAdmins.dataValues.mainRoleId
            ...
            const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                ...
                .addFields(
                    ...
                    { name: " ", value: " ", inline: false },
                    { name: "Server ID", value: "`" + mainServerId + "`", inline: true },
                    { name: "Server Name", value: "`" + serverName + "`", inline: true },
                    { name: " ", value: " ", inline: false },
                    { name: "Role ID", value: "`" + mainRoleId + "`", inline: true },
                    { name: "Role Name", value: "<@&" + mainRoleId + ">", inline: true },
                    { name: " ", value: " ", inline: false },
                    { name: "Role ID", value: "`" + logChannelId + "`", inline: true },
                    { name: "Role Name", value: "<#" + logChannelId + ">", inline: true },
                    { name: " ", value: " ", inline: false },
        ...
        let reportCommand = "/admin-teamPage"
