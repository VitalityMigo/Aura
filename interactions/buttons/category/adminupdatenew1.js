...
module.exports = {
    id: 'RCDashboardNewUpdate-button',
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            const passwordAdminDashboard = new ModalBuilder()
                .setCustomId('RCDashboardNewUpdateModal')
                .setTitle('New Update');
            ...
            const content = new TextInputBuilder()
                .setCustomId('RCDashboardNewUpdateModalR1')
                .setLabel("Content")
                .setPlaceholder('What do you want to send ?')
                .setStyle(TextInputStyle.Paragraph)
               

         
            const thirdActionRowSetProfile = new ActionRowBuilder().addComponents(content);

            // Add inputs to the modal
            passwordAdminDashboard.addComponents(thirdActionRowSetProfile)
        ...
        let reportCommand = "/admin-updateNew1"
