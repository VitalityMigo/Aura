            ...
            if (userSetup != null) {
                ...
                if (ape_mode == "true") {
                    ...
                    if (provided_value != "x%") {
                        ...
                        // On défini le ratio a vendre en fonction du customId
                        let ratio
                        if (provided_value == "25%") { ratio = 25 }
                        else if (provided_value == "50%") { ratio = 50 }
                        else if (provided_value == "75%") { ratio = 75 }
                        else if (provided_value == "100%") { ratio = 100 }
                    ...
                    } else if (provided_value == "x%") {


                        const passwordAdminDashboard = new ModalBuilder()
                            .setCustomId('modal_coin_exec_sell_' + contract + "@x%")
                            .setTitle('Sell Coin');
                        ...
                        const channel = new TextInputBuilder()
                            .setCustomId('modal_coin_exec_sell_' + contract + "@x%R1")
                            .setLabel("Amount")
                            .setPlaceholder("The ratio to sell in % (35 for 35%)")
                                ...
                                if (trade.hasAllowance == false) {
                                    ...
                                    if (simulation.valid == true) {
                                        ...
                                        if (gas !== null && gas.valid == true) {
                                            ...
                                            const totalValue = parseFloat(trade.amountExpected) - parseFloat(gas.fees)
