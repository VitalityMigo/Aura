...
module.exports = {
    id: 'friendtechairdrop-frennotfrenmenu-button',
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const frenTable = JSON.parse(embed1)
                ...
                const frenTableFiltered = frenTable.filter(obj => obj.relation == "(3, 0)")
                ...
                if (frenfrenFormatted == "Username                 Amount    Holding      Relation\n\n") { frenfrenFormatted = "No Fren, Not Fren relation found for this user           " }
