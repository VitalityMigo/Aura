...
module.exports = {
    id: 'friendtech-interactionlastpage-button',
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                await interaction.update({ embeds: [userFTEmbed], components: [buttonsRow] });


                await interactionData.update({ actualPage: pageIndex.toString(), }, { where: { authorId: authorId, commandName: "friendtech-interactions", serverId: serverId } })
