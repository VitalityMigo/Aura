...
module.exports = {
    id: 'friendtechairdrop-leaderboardbyairdrop-button',
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const byFrenCall = await axios.get('https://preview.frenfren.pro/api/trpc/users.autocomplete,users.frens?batch=1&input={"0":{"json":""},"1":{"json":{"orderBy":"totalPoints"}}}')
