...
module.exports = {
    id: 'friendtechairdrop-notfrenfrenmenu-button',
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const frenTableFiltered = frenTable.filter(obj => obj.relation == "(0, 3)")
                ...
                if (frenfrenFormatted == "Username                 Amount    Holding      Relation\n\n") { frenfrenFormatted = "No Not Fren, Fren relation found for this user           " }
