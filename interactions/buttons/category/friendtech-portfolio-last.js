...
module.exports = {
    id: 'friendtech-portfolio-last-button',
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                let holdingTableSorted = holderTableFull.slice(firstObject, lastObject);
                ...
                buttonRow1.components.find(obj => obj.data.label === "next page").data.disabled = true
                buttonRow1.components.find(obj => obj.data.label === "last page").data.disabled = true
                buttonRow1.components.find(obj => obj.data.label === "first page").data.disabled = false
                buttonRow1.components.find(obj => obj.data.label === "previous page").data.disabled = false
                ...
                await interactionData.update({ actualPage: pageIndex.toString(), }, { where: { authorId: authorId, commandName: "friendtech-portfolio", serverId: serverId } })
