...
const { accessSql, profileData, adminsql, reportsql, tracker_friendTech, sequelize } = require('../../../events/database');
...
module.exports = {
    id: 'friendtechtrackerinfra-newtracker-button',
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const passwordAdminDashboard = new ModalBuilder()
                    .setCustomId('friendtechtrackerinfra-newtracker-modal')
                    .setTitle('Add User(s)');
                ...
                const channel = new TextInputBuilder()
                    .setCustomId('friendtechtrackerinfra-newtracker-modalR1')
                    .setLabel("User List (" + trackerLeft + " spots left)")
                    .setPlaceholder("One or few twitter username (i.e skayznft, apedegennft)")
                ...
                .setDescription("You've already reached the limit of 25 tracked Friend Tech user. Please delete some of your currently tracked users before adding new ones.")
