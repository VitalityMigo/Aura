...
module.exports = {
    id: 'friendtechholderlast-button',
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const top50Holders = holderDataTable[0].top50Holders
                ...
                const getBlurOneWallet = new EmbedBuilder().setColor("#060A8F")
                    ...
                    .addFields(
                        ...
                        { name: "Top 10 Holders", value: "`" + top10Holders + "`", inline: true },
                        { name: "Top 25 Holders", value: "`" + top25Holders + "`", inline: true },
                        { name: "Top 50 Holders", value: "`" + top50Holders + "`", inline: true },
                ...
                await interactionData.update({ actualPage: pageIndex.toString(), }, { where: { authorId: authorId, commandName: "friendtech-holder", serverId: serverId } })
