...
module.exports = {
    id: 'zzzgetwalletfirstpage-button',
    ...
    async execute(interaction, message) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            if (selectedChain.toLowerCase() == "eth") {
                ...
                await interactionData.update({ actualPage: "1", }, { where: { commandName: "getwallet", authorId: authorId, serverId: serverId } })
            ...
            let reportCommand = "/getwallet-firstPage"
