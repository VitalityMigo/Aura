...
const buttonAllAvailableEnd = new ActionRowBuilder()
    .addComponents(
        new ButtonBuilder()
            .setCustomId('zzzgetwalletfirstpage-button')
            .setLabel('first page')
...
const buttonAllAllAvailableEnd = new ActionRowBuilder()
    .addComponents(
        new ButtonBuilder()
            .setCustomId('zzzgetwalletfirstpage-button')
            .setLabel('first page')
...
const buttonAllAvailableEnd1 = new ActionRowBuilder()
    .addComponents(
        new ButtonBuilder()
            .setCustomId('zzzgetwalletfirstpage-button')
            .setLabel('first page')
...
const buttonAllAllAvailableEnd1 = new ActionRowBuilder()
    .addComponents(
        new ButtonBuilder()
            .setCustomId('zzzgetwalletfirstpage-button')
            .setLabel('first page')
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            if (walletShow.toLowerCase() == "no") {
                ...
                if (selectedChain.toLowerCase() == "eth") {
                    ...
                    if (actualPage == 1) { walletEthSliced = filteredByWalletETH.slice(0, 8) } else if (actualPage == 2) { walletEthSliced = filteredByWalletETH.slice(8, 16) } else if (actualPage == 3) { walletEthSliced = filteredByWalletETH.slice(16, 24); }
                    ...
                    let walletStop = parseInt(walletEthSliced.length) - 1
                    ...
                    for (const object of walletEthSliced) {
                        ...
                        if (object.walletChain == "eth") {
                            ...
                            if (fieldCount < 8) {
                                ...
                                console.log("yes/no:" + walletShow + "field: " + fieldCount + " / stop: " + walletStop)

                                if (fieldCount == 7 || walletStop == fieldCount) {
                    ...
                    if (actualPage == 1) {
                        ...
                        await interaction.update({ embeds: [getwalletsAllEmbed], components: [buttonAllAvailableEnd, buttonShowName1] })
                        ...
                        if (pageIndex == 2) {
                            ...
                            await interaction.update({ embeds: [getwalletsAllEmbed], components: [buttonAllAllAvailableEnd, buttonShowName1] })

                        }
                    }


                    await interactionData.update({ walletName: "yes" }, { where: { commandName: "getwallet", authorId: authorId, serverId: serverId } })
                    ...
                    if (actualPage == 1) {
                        ...
                        await interaction.update({ embeds: [getwalletsAllEmbed], components: [buttonAllAvailableEnd1, buttonShowName] })
                        ...
                        if (pageIndex == 2) {
                            ...
                            await interaction.update({ embeds: [getwalletsAllEmbed], components: [buttonAllAllAvailableEnd1, buttonShowName] })
            ...
            } else if (walletShow.toLowerCase() == "yes") {
                ...
                if (selectedChain.toLowerCase() == "eth") {
                    ...
                    if (actualPage == 1) {
                        ...
                        await interaction.update({ embeds: [getwalletsAllEmbed], components: [buttonAllAvailableEnd, buttonShowName] })
                        ...
                        if (pageIndex == 2) {
                            ...
                            await interaction.update({ embeds: [getwalletsAllEmbed], components: [buttonAllAllAvailableEnd, buttonShowName] })

                        }
                    }


                    await interactionData.update({ walletName: "no" }, { where: { commandName: "getwallet", authorId: authorId, serverId: serverId } })
            ...
            let reportCommand = "/getwallet-hid&showName"
