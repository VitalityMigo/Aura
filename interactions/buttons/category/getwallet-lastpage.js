...
module.exports = {
    id: 'zzzgetwalletlastpage-button',
    ...
    async execute(interaction, message) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            if (selectedChain.toLowerCase() === "eth") {
                ...
                let walletEthSliced = []
                if (pageIndex == 2) { walletEthSliced = filteredByWalletETH.slice(8, 16) } else if (pageIndex == 3) { walletEthSliced = filteredByWalletETH.slice(16, 24); }
                ...
                await interactionData.update({ actualPage: pageIndex.toString(), }, { where: { commandName: "getwallet", authorId: authorId, serverId: serverId } })
            ...
            let reportCommand = "/getwallet-lastpage"
