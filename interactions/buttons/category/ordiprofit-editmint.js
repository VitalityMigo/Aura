...
const { accessSql, adminsql, reportsql, interactionData } = require('../../../events/database');
...
module.exports = {
    id: 'ordiprofit-edit-mintvalue-button',
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const actionRow = new ActionRowBuilder().addComponents(mintValue);
               

                // Add inputs to the modal
                passwordAdminDashboard.addComponents(actionRow)
