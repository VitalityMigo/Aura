...
const buttons1Row = new ActionRowBuilder()
    .addComponents(
        new ButtonBuilder()
            ...
            .setStyle(4),
        new ButtonBuilder()
            .setCustomId('setupGuideStep3-button')
            .setLabel('Continue')
            .setStyle(3),
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                ...
                .setDescription("If this is your first time using Aura, the first step is to create a public profile. This will be viewable by all users in the community in which you are using Aura. \n\nUse `/profile` to access your personal dashboard, then click on public profile, and create your own.\n\nWith that done, let's move on..\n\n`[2/4]`")
                .setAuthor({ name: authorName, iconURL: userAvatar })
                .setTimestamp()
                .setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })

            await interaction.update({ embeds: [passwordManagement], components: [buttons1Row], ephemeral: true });
            ...
            let reportCommand = "/setup-GuideStep2"
