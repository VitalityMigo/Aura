  ...
  async execute(interaction) {
    ...
    try {
      ...
      if (interaction.message.interaction.user.id === authorId) {
        ...
        const lastInteractionRcprofit = await interactionData.findOne({ where: { authorId: authorId, commandName: "solprofit", serverId: serverId } })
        ...
        let symbol = lastInteractionRcprofit.dataValues.collectionSlug
        ...
        if (serverId === "949291624389816331") {
          ...
          if (visualSelect === "2" || privacyBigDataAuthor === null) {
            ...
            ctx.font = "bold 22px Futura";
            ctx.fillStyle = "#ffffff";
            ctx.fillText((parseFloat((remaining * floorPrice).toFixed(3))).toString() + " SOL", 337, 548.5);


            //REALIZED PROFIT
            ctx.font = "bold 22px Futura";
            ctx.fillStyle = "#ffffff";
            ctx.fillText(parseFloat(realisedProfit).toFixed(3) + " SOL", 337, 594);
            ...
            ctx.fillStyle = "#ffffff";
            const text = parseFloat(potentialProfit).toFixed(3) + " SOL" // (" + Intl.NumberFormat('en-US').format((parseFloat(potentialProfit * solPrice).toFixed(0))) + "$)";
            ctx.font = "bold 35px Futura";
            const text2 = "(" + Intl.NumberFormat('en-US').format((parseFloat(potentialProfit * solPrice).toFixed(0))) + "$)";
            ...
            ctx.font = "bold 28px Futura";
            ctx.fillStyle = "#ffffff";
            ctx.fillText(parseFloat(avgBuy).toFixed(3) + " SOL", 343, 823);

            //AVG SALE VALUE
            ctx.font = "bold 28px Futura";
            ctx.fillStyle = "#ffffff";
            ctx.fillText(parseFloat(avgSold).toFixed(3) + " SOL", 343, 872);
            ...
            ctx.font = "bold 28px Futura";
            ctx.fillStyle = "#ffffff";
            ctx.fillText((parseFloat(remaining * floorPrice).toFixed(3)).toString() + " SOL", 840, 823);

            //REALIZED PROFIT
            ctx.font = "bold 28px Futura";
            ctx.fillStyle = "#ffffff";
            ctx.fillText(parseFloat(realisedProfit).toFixed(3) + " SOL", 840, 872);
            ...
            if (potentialProfit >= 0) { ctx.fillStyle = "#00db00"; } else if (potentialProfit < 0) { ctx.fillStyle = "#e60015"; }
            ctx.fillText("$" + Intl.NumberFormat('en-US').format((parseFloat(potentialProfit * solPrice).toFixed(0))), 45, 653);

            //POTENTIAL PROFIT (ETH)
            ctx.font = "bold 80px SFTransrobotic";
            if (potentialProfit >= 0) { ctx.fillStyle = "#00db00"; } else if (potentialProfit < 0) { ctx.fillStyle = "#e60015"; }
            ctx.fillText(parseFloat(potentialProfit).toFixed(3) + " SOL", 547, 653);
            ...
            ctx.font = "bold 31px Futura";
            ctx.fillStyle = "#E5EAFF";
            const avgBuyCountText = ctx.measureText((parseFloat(avgBuy).toFixed(3)).toString() + " SOL").width
            ctx.fillText((parseFloat(avgBuy).toFixed(3)).toString() + " SOL", 795 - avgBuyCountText / 2, 420);
            ...
            ctx.font = "bold 31px Futura";
            ctx.fillStyle = "#E5EAFF";
            const avgSoldText = ctx.measureText((parseFloat(avgSold).toFixed(3)).toString() + " SOL").width
            ctx.fillText((parseFloat(avgSold).toFixed(3)).toString() + " SOL", 795 - avgSoldText / 2, 585);


            //REALIZED PROFIT
            ctx.font = "bold 31px Futura";
            if (realisedProfit >= 0) { ctx.fillStyle = "#00db00"; } else if (potentialProfit < 0) { ctx.fillStyle = "#e60015"; }
            const realisedProfitText = ctx.measureText((parseFloat(realisedProfit).toFixed(3)).toString() + " SOL").width
            ctx.fillText((parseFloat(realisedProfit).toFixed(3)).toString() + " SOL", 201 - realisedProfitText / 2, 749);

            //Potential PROFIT
            ctx.font = "bold 31px Futura";
            if (potentialProfit >= 0) { ctx.fillStyle = "#00db00"; } else if (potentialProfit < 0) { ctx.fillStyle = "#e60015"; }
            const potentialProfitText = ctx.measureText((parseFloat(potentialProfit).toFixed(3)).toString() + " SOL").width
            ctx.fillText((parseFloat(potentialProfit).toFixed(3)).toString() + " SOL", 498 - potentialProfitText / 2, 749);
          ...
          ctx.font = "bold 38px Courrier New";
          ctx.fillStyle = "#ffffff";
          const avgSpentTextSize = ctx.measureText(parseFloat(avgBuy).toFixed(3) + " SOL").width;
          ctx.fillText(parseFloat(avgBuy).toFixed(3) + " SOL", 222 - avgSpentTextSize / 2, 740);

          //AVG SALE VALUE
          ctx.font = "bold 38px Courrier New";
          ctx.fillStyle = "#ffffff";
          const avgSaleTextSize = ctx.measureText(parseFloat(avgSold).toFixed(3) + " SOL").width;
          ctx.fillText(parseFloat(avgSold).toFixed(3) + " SOL", 504 - avgSaleTextSize / 2, 740);


          //Realized PROFIT (ETH)
          ctx.font = "bold 38px Courrier New";
          //if (realisedProfit >= 0) { ctx.fillStyle = "#00db00"; } else if (realisedProfit < 0) { ctx.fillStyle = "#e60015"; }
          const realizedProfitTextSize = ctx.measureText(parseFloat(realisedProfit).toFixed(3) + " SOL").width;
          ctx.fillText(parseFloat(realisedProfit).toFixed(3) + " SOL", 803 - realizedProfitTextSize / 2, 740);
          ...
          if (potentialProfit >= 0) { ctx.fillStyle = "#00db00"; } else if (potentialProfit < 0) { ctx.fillStyle = "#e60015"; }
          const potentialProfitTextSize = ctx.measureText(parseFloat(potentialProfit).toFixed(3) + " SOL (" + potentialRoiFormatted + "%)").width;
          ctx.fillText(parseFloat(potentialProfit).toFixed(3) + " SOL (" + potentialRoiFormatted + "%)", 500 - potentialProfitTextSize / 2, 876);
          ...
          ctx.font = "38px rbt";
          ctx.fillStyle = "#04D9FF";
          const usdTx = parseFloat(potentialProfit * solPrice).toFixed(2) + " USD"
          ...
          // Cout total
          // ON commence par formatter le texte
          const spentTx = parseFloat(totalBuy).toFixed(3) + " SOL"
          // Puis on met la font et la couleur
          ...
          // Sales total
          // ON commence par formatter le texte
          const salesTx = parseFloat(totalSell).toFixed(3) + " SOL"
          // Puis on met la font et la couleur
          ctx.font = "light 19px rbt";
          ctx.fillStyle = "#E7E7E7";
          // Enfin on calcul la taille et remplit
          ...
          const buyTXT = "$" + formatDollars(totalBuy * solPrice)
          ctx.font = " 50px 'UTM Futura Extra'";
          ctx.fillStyle = "#828282";
          ctx.fillText(buyTXT, 658, 496);

          const profitUsdTXT = "$" + formatDollars(potentialProfit * solPrice)
          ctx.font = " 50px 'UTM Futura Extra'";
          ctx.fillStyle = "#828282";
          ...
          if (realisedProfit >= 0) { ctx.fillStyle = "#00db00"; } else if (potentialProfit < 0) { ctx.fillStyle = "#e60015"; }
          const realisedProfitText = ctx.measureText((parseFloat(realisedProfit).toFixed(3)).toString() + " SOL").width
          ctx.fillText((parseFloat(realisedProfit).toFixed(3)).toString() + " SOL", 190 - realisedProfitText / 2, 749);

          //Potential PROFIT
          ctx.font = "700 35px 'Fira Code'";
          if (potentialProfit >= 0) { ctx.fillStyle = "#00db00"; } else if (potentialProfit < 0) { ctx.fillStyle = "#e60015"; }
          const potentialProfitText = ctx.measureText((parseFloat(potentialProfit).toFixed(3)).toString() + " SOL").width
          ctx.fillText((parseFloat(potentialProfit).toFixed(3)).toString() + " SOL", 500 - potentialProfitText / 2, 749);
