    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.user.id === authorId) {
                ...
                let userCount = communityAccess.dataValues.userCount
                ...
                if (communityStatut.toLowerCase() === "active") {
                    ...
                    const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                        ...
                        .addFields(
                            ...
                            { name: "Max Users", value: "`" + userCount + " users`", inline: true },
                            { name: " ", value: " ", inline: false },
                            { name: " ", value: "The wallet of Aura is the following:\n`0x862284B87b774bbEC86c4f13bA6c283C4552AfAB (rollschasers.eth)`", inline: false },
                            { name: " ", value: " ", inline: false },
                    ...
                    const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                        ...
                        .addFields(
                            ...
                            { name: " ", value: "The wallet of Aura is the following:\n`0x862284B87b774bbEC86c4f13bA6c283C4552AfAB (rollschasers.eth)`", inline: false },
                            { name: " ", value: " ", inline: false },
                            { name: " ", value: "⚠️*Your community's access to the bot will been suspended soon because your monthly payment havn't been made. Please contact our team to keep your access to the bot.*", inline: false },
                            { name: " ", value: " ", inline: false },
