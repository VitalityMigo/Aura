...
module.exports = {
    id: 'adminDashboardPassword-button',
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            let actualPassword = communityAccess.dataValues.password

            const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                .setTitle("Team Dashboard")
                .setDescription(">>> Modify your password to the bot")
        ...
        let reportCommand = "/team-password"
