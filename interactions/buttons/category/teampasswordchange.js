...
module.exports = {
    id: 'adminDashboardPasswordChange-button',
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            const passwordAdminDashboard = new ModalBuilder()
                .setCustomId('passwordAdminDashboardChange')
            ...
            const password1 = new TextInputBuilder()
                .setCustomId('passwordAdminDashboardChangeR1')
                .setLabel("Current Password")
                .setPlaceholder('The current community password')
                .setStyle(TextInputStyle.Short)
                .setMinLength(5)
                .setMaxLength(25);

            const password2 = new TextInputBuilder()
                .setCustomId('passwordAdminDashboardChangeR2')
                .setLabel("New Password")
                .setPlaceholder("The new community password you want to set")
                .setStyle(TextInputStyle.Short)
                .setMinLength(5)
                .setMaxLength(25);

            const password3 = new TextInputBuilder()
                .setCustomId('passwordAdminDashboardChangeR3')
                .setLabel("Confirm New Password")
                .setPlaceholder("Confirm the new community password you want to set")
                .setStyle(TextInputStyle.Short)
                .setMinLength(5)
                .setMaxLength(25);
            ...
            passwordAdminDashboard.addComponents(firstActionRowSetProfile, secondActionRowSetProfile, thirdActionRowSetProfile)
