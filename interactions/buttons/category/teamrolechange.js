...
module.exports = {
    id: 'adminDashboardRoleChange-button',
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            const passwordAdminDashboard = new ModalBuilder()
                .setCustomId('roleAdminDashboardChange')
                .setTitle('Change Roles Access');

            // Add components to modal

            // Create the text input components
            const role1 = new TextInputBuilder()
                .setCustomId('roleAdminDashboardChangeR1')
            ...
            const role2 = new TextInputBuilder()
                .setCustomId('roleMemberDashboardChangeR1')
            ...
            const firstActionRowSetProfile = new ActionRowBuilder().addComponents(role1);
            const secondActionRowSetProfile = new ActionRowBuilder().addComponents(role2);
