...
const buttonRowAdminDashboard = new ActionRowBuilder()
    .addComponents(
        new ButtonBuilder()
            .setCustomId('adminDashboardRoleChange-button')
            .setLabel('modify')
            .setStyle(2),
        new ButtonBuilder()
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                let adminRoleId = communityAccess.dataValues.adminRoleId
                let memberRoleId = communityAccess.dataValues.memberRoleId
                ...
                const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                    ...
                    .addFields(
                        ...
                        { name: " ", value: " ", inline: false },
                        { name: "Admin Role ID", value: "`" + adminRoleId + "`", inline: true },
                        { name: "Member Role ID", value: "`" + memberRoleId + "`", inline: true },
                        { name: " ", value: " ", inline: false },
            ...
            let reportCommand = "/team-rolesPage"
