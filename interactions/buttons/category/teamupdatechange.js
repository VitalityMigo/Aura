...
module.exports = {
    id: 'adminDashboardUpdateChange-button',
        ...
        try {
            ...
            if (interaction.message.interaction.user.id === authorId) {
                ...
                const passwordAdminDashboard = new ModalBuilder()
                    .setCustomId('updateAdminDashboardChange')
                    .setTitle('Change Update Channel');
                ...
                const channel2 = new TextInputBuilder()
                    .setCustomId('updateAdminDashboardChangeR0')
                    .setLabel("New Admin Update Channel ID")
                    .setPlaceholder('The ID of the channel you want to receive update in')
                ...
                const channel = new TextInputBuilder()
                    .setCustomId('updateAdminDashboardChangeR1')
                    .setLabel("New Community Update Channel ID")
                    .setPlaceholder('The ID of the channel you want to receive update in')
                    .setStyle(TextInputStyle.Short)
                    .setMinLength(5)
                    .setMaxLength(25);
