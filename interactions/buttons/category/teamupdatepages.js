...
module.exports = {
    id: 'adminDashboardUpdate-button',
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            let updateChannel = communityAccess.dataValues.updateChannel
            let adminUpdateChannel = communityAccess.dataValues.adminUpdateChannel
            ...
            const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                ...
                .addFields(
                    ...
                    { name: " ", value: " ", inline: false },
                    { name: "Admin Update Channel", value: "<#" + updateChannel + ">", inline: true },
                    { name: "Admin Update Channel ID", value: "`" + updateChannel + "`", inline: true },
                    { name: " ", value: " ", inline: false },
                    { name: "Community Update Channel", value: "<#" + adminUpdateChannel + ">", inline: true },
                    { name: "Community Update Channel ID", value: "`" + adminUpdateChannel + "`", inline: true },
                    { name: " ", value: " ", inline: false },
        ...
        let reportCommand = "/team-updatePage"
