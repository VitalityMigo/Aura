    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            if (walletCategory.toLowerCase() === "eth") {
                ...
                tokenTable.sort((a, b) => a.collection.localeCompare(b.collection));
                ...
                tokenTable.sort((a, b) => a.name.localeCompare(b.name));
            ...
            let reportCommand = "/trackmints-byabc"
