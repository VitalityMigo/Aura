...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            if (privacyMode.toLowerCase() === "private") {
                ...
                const turnPrivateModeEmbed = new EmbedBuilder().setColor("#060A8F")
                    ...
                    .addFields(
                        ...
                        { name: " ", value: " ", inline: false },
                        { name: "Status", value: "Your are now in `public mode 🔓`", inline: false },
                        { name: " ", value: " ", inline: false },
                ...
                await interaction.update({ embeds: [turnPrivateModeEmbed], components: [buttonsRowprivate] });
                ...
                const errorturnPublicModeEmbed = new EmbedBuilder().setColor("#060A8F")
                    .setTitle(authorName + "'s privacy")
                ...
                await interaction.update({ embeds: [errorturnPublicModeEmbed] });
            }
