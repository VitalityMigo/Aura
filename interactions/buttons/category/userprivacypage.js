...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            if (privacyMode.toLowerCase() === "private") { await interaction.update({ embeds: [privateMode], components: [buttonsRowpublic] }); }
            if (privacyMode.toLowerCase() === "public") { await interaction.update({ embeds: [privateMode], components: [buttonsRowprivate] }); }
        ...
        let reportCommand = "/user-privacyPage"
