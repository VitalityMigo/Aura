...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.message.interaction.user.id === authorId) {
            ...
            const userProfile = await profileData.findAll({ where: { authorId: userId } })
            ...
            const resetProfile = new EmbedBuilder().setColor("#060A8F")
                ...
                .addFields(
                    ...
                    { name: " ", value: " ", inline: false },
                    { name: "Status", value: "Your profile has been `reset` successfully.", inline: false },
        ...
        let reportCommand = "/user-resetProfile"
