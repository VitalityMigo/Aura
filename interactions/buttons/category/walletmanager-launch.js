    ...
    async execute(interaction) {
        ...
        //try {
            ...
            console.log("// Step 1 : Initialization - Executed ✅")
                ...
                .addComponents(
                    new ButtonBuilder()
                        .setCustomId('walletmanagergenerate-button')
                        .setLabel('generate')
                        .setStyle(2),
                    new ButtonBuilder()
                        .setCustomId('walletmanagerdisperse-button')
                        .setLabel('disperse')
                        .setStyle(2),
                    new ButtonBuilder()
                        .setCustomId('walletmanagerconsolidate-button')
                        .setLabel('consolidate')
                        .setStyle(2),
                    new ButtonBuilder()
                        .setCustomId('walletmanagersetup-button')
                        .setLabel('setup')
                        .setStyle(1),
                ...
                await interaction.reply({ embeds: [walletManager], components: [buttons1Row], ephemeral: true });
