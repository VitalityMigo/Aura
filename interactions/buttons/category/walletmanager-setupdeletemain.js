...
module.exports = {
    id: 'walletmanagersetupdeletemain-button',
    ...
    async execute(interaction) {
        ...
        await walletManager.destroy({ where: { authorId: authorId } })



        const walletManagerDestroy = new EmbedBuilder().setColor("#060A8F")
            ...
            .addFields(
                ...
                { name: " ", value: " ", inline: false },
                { name: " ", value: "*✅ Your main wallet has been deleted from your profile.*", inline: false },
        ...
        await interaction.update({ embeds: [walletManagerDestroy], components: [buttons1Row] });
