...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const auth = interaction.fields.getTextInputValue('button_nft_infra_blurAuthR1')
            ...
            const setfpEmbedNotForYou = new EmbedBuilder().setColor("#060A8F")
                ...
                .setDescription("Logged on to Blur succesfully, you can now use the trading feature again. Blur usually asks to do that step about once a month ✅")
