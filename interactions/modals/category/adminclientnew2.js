...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await accessSql.update({
            ...
            subscribtionStatut: "30"



        }, { where: { adminRoleId: null, memberRoleId: null, updateChannel: null, adminWalletAddress: null, statut: null, subscribtionStatut: null } })
        ...
        //On envoi une notif au serveur main
        ...
        const updateEmbed = new EmbedBuilder().setColor("#40F214")
            .setTitle("New Client")
            .setDescription(">>> A community has just been registered.")
        ...
        let reportCommand = "/admin-clientNew2"
