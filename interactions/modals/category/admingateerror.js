...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const givenIdentifiant = interaction.fields.getTextInputValue('identifiantRCDashboardErrorRange1');
            const givenPassword = interaction.fields.getTextInputValue('passwordRCDashboardErrorRange1');
