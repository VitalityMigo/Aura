...
const buttonsRow1 = new ActionRowBuilder()
    .addComponents(
        new ButtonBuilder()
            .setCustomId('getaccessRCauthentificate-button')
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const walletAddress = interaction.fields.getTextInputValue('getaccessRCwalletaddressR1');
        ...
        await interactionData.create({
            ...
            commandName: "getAccessRCAuthentificate-button",
            serverId:serverId
        })
