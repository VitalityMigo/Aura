...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const givenPassword = interaction.fields.getTextInputValue('passwordAdminDashboardRange1');
            ...
            if (givenPassword.toString() === communityPassword.toString()) {
                ...
                await interaction.editReply({ embeds: [adminDashboardMainEmbed], components: [buttonRowAdminDashboard] })
