...
const buttonRowAdminDashboard = new ActionRowBuilder()
    .addComponents(
        new ButtonBuilder()
            .setCustomId('adminDashboardPassword-button')
            .setLabel('password')
            .setStyle(2),
        new ButtonBuilder()
...
const buttonRowAdminDashboard2 = new ActionRowBuilder()
    .addComponents(
        new ButtonBuilder()
            .setCustomId('adminDashboardPasswordError-button')
            .setLabel('try again')
            .setStyle(2),
    );
...
module.exports = {
    id: "passwordAdminDashboardError",
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const givenPassword = interaction.fields.getTextInputValue('passwordAdminDashboardErrorRange1');
            ...
            if (givenPassword.toString() === communityPassword.toString()) {
                ...
                const adminDashboardMainEmbed = new EmbedBuilder().setColor("#060A8F")
                    ...
                    .addFields(
                        ...
                        { name: 'Dashboard', value: "This page allows you to modify the settings of the Rolls Chasers Analytics Bot in your community. Make sure to always remember your password to be able to access it, and never share it.", inline: false },
                        { name: ' ', value: " ", inline: false },
                        { name: 'Settings', value: "`Password` - Manage the community's administrator password\n`Roles` - Manage the community's access to the bot\n`Update` - Manage the community's updates channel\n`Subscribtion` - Manage your community's subscribtion\n`Marketing` - Create marketing content easily", inline: false },
                    )
                    .setTimestamp()
                ...
                const adminDashboardMainEmbedError = new EmbedBuilder().setColor("#060A8F")
                    .setTitle("Team Dashboard")
                    .setAuthor({ name: authorName, iconURL: userAvatar })
                    .setDescription("The password you entered is incorrect. Try another password or contact an admin if you need help.")
                    .setThumbnail('https://cdn.discordapp.com/attachments/1108757847208099941/1133190291428479016/image.png')
                    .setTimestamp()
                    .setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })


                await interaction.update({ embeds: [adminDashboardMainEmbedError], components: [buttonRowAdminDashboard2] })
                // FAIRE UN BOUTTON TRY AGAIN
            }
            ...
            let reportCommand = "/team-gateTryAgain"
            ...
            await interaction.update({ embeds: [errorAnswerUser], ephemeral: true });
