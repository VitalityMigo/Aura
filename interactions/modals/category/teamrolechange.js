...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const givenAdminRole = interaction.fields.getTextInputValue('roleAdminDashboardChangeR1');
            const givenMemberRole = interaction.fields.getTextInputValue('roleMemberDashboardChangeR1');
            ...
            await accessSql.update({ memberRoleId: givenMemberRole.toString(), adminRoleId: givenAdminRole.toString() }, { where: { serverId: serverId } })


            const passwordManagement = new EmbedBuilder().setColor("#060A8F")
                .setTitle("Team Dashboard")
                .setDescription(">>> Modify the community roles that have access to the bot")
            ...
            let reportCommand = "/team-roleChange"
