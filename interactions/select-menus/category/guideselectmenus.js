		...
		if (interaction.values[0] == "selectMainpage") {
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/cryptoprofit)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/data)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/derisk)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/ens)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/gas-calculator)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: 'Specificity', value: "The data displayed by this command are only estimation, please do your due diligence to adapt them to your situation.", inline: false },
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/gas-tracker)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/profile)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/market)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: 'Specificity', value: "The wallet selection is user-based, which means that the wallets you registered using `/wallet set` or `/wallet raw` are the same accross all your server that have access to the bot.", inline: false },
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/portfolio)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/privacy)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: 'Specificity', value: "Please note that if you encounter an error using this command, it might be because few collections have the same name. You can also enter directly the contract address (for Ethereum) or the symbol (for Bitcoin).", inline: false },
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/profit)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/rcprofit)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/report)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/team)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/vouch)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/vouchleaderboard)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/wallet-set)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/walletgenerator)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://aura-3.gitbook.io/aura/commands/commands/wathclist-set)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
