		...
		if (interaction.values[0] == "selectMainpage") {
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/access)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/setalert)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/blur)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/coin)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/cryptoprofit)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/data)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/derisk)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/ens)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/gascalculator)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: 'Specificity', value: "The data displayed by this command are only estimation, please do your due diligence to adapt them to your situation.", inline: false },
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/gastracker)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/profile)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/market)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: 'Specificity', value: "The wallet selection is user-based, which means that the wallets you registered using /setwallet are the same accross all your server that have access to the bot.", inline: false },
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/portfolio)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/privacy)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: 'Specificity', value: "Please note that if you encounter an error using this command, it might be because few collections have the same name. You can also enter directly the contract address (for Ethereum) or the symbol (for Bitcoin).", inline: false },
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/profit)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/rcprofit)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/report)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/team)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/vouch)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/vouchleaderboard)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/setwallet)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/walletgenerator)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
			...
			const embedGuide = new EmbedBuilder().setColor("#060A8F")
				...
				.addFields(
					...
					{ name: ' ', value: " ", inline: false },
					{ name: ' ', value: "*For a full presentation of the command, click [here](https://app.gitbook.com/o/j7C1DeeFIe87I5WriMNd/s/ZDuK6mLS9VHF7MYtbAzX/commands/setwatchlist)*", inline: false },
				)
				.setTimestamp()
				.setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
