...
const { baseNftProfitSingle, baseNftProfitMulitWallet } = require("../../../functions/basecalculator")
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("base")
        .setDescription("Base analytics features")
        .addSubcommand(subcommand =>
            subcommand
                .setName("profit")
                .setDescription("Display your profit on a Base collection")
                            ...
                            if (subcommand === 'profit') {
                                ...
                                if (isValidEthereumAddress(contract)) {
                                    ...
                                    if (isValidEthereumAddress(wallet)) {
                                        ...
                                        const data = await baseNftProfitSingle(contract, wallet, time)
                                    ...
                                    if (isValidEthereumAddress(wallet)) {
                                        ...
                                        const setwalletErrorEmbed = new EmbedBuilder().setColor("#060A8F")
                                            .setTitle(`Not available`)
                                            .setDescription("We are currently optimising this feature. You can still use Base NFT profit on a **single** collection with `/base profit`.")
                                            .setThumbnail('https://cdn.discordapp.com/attachments/1108757847208099941/1133190291428479016/image.png')
                                            .setAuthor({ name: authorName, iconURL: userAvatar })
                                            .setTimestamp()
                                            .setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
                                        ...
                                        const setwalletErrorEmbed = new EmbedBuilder().setColor("#060A8F")
                                            .setTitle(`Not available`)
                                            .setDescription("We are currently optimising this feature. You can still use Base NFT profit on a **single** wallet with `/base profit`.")
                                            .setThumbnail('https://cdn.discordapp.com/attachments/1108757847208099941/1133190291428479016/image.png')
                                            .setAuthor({ name: authorName, iconURL: userAvatar })
                                            .setTimestamp()
                                            .setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
                                    ...
                                    const setwalletErrorEmbed = new EmbedBuilder().setColor("#060A8F")
                                        ...
                                        .setDescription("The Base NFT collection you provided isn't a valid Ethereum contract address. Please try again using the appropriate form.")
                                        .setThumbnail('https://cdn.discordapp.com/attachments/1108757847208099941/1133190291428479016/image.png')
                                        .setAuthor({ name: authorName, iconURL: userAvatar })
                                        .setTimestamp()
                                        .setFooter({ text: 'Powered by Rolls Chasers', iconURL: 'https://cdn.discordapp.com/attachments/1108757872315219968/1121978623436521514/rc_logo.png' })
