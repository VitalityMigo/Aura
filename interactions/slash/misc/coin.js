...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName("chart")
                .setDescription("Display the coin's chart")
                .addStringOption(option =>
                    option
                        .setName("coin")
                        .setDescription("The name or contract address of the coin")
                        .setRequired(true)
                        .setAutocomplete(true)
                ),
        ),
                    ...
                    if (community.tier === 's-tier' || community.tier === 'a-tier' || freeAccess(subcommand, excluded)) {
                        ...
                        if (member.roles.cache.has(community.member)) {
                            ...
                            if (subcommand === 'profit') {
                                ...
                                const contract = interaction.options.getString("coin");
