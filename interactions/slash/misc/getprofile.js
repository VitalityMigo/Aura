            ...
            if (communityStatut.toLowerCase() === "active") {
                ...
                if (botPowerStatut.toLowerCase() === "on") {
                    ...
                    if (member.roles.cache.has(communityMemberRoleId)) {
                        ...
                        const selectedUser = interaction.options.getString("member");

                        const baseStringDiscordId = "0123456789 ";
                        const appropriateForm = new RegExp(`[^${baseStringDiscordId}]`, "g");
                        const cleanDiscordId = selectedUser.replace(appropriateForm, "");
