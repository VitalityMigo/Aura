...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("inscription")
        .setDescription("Display data of a single Bitcoin inscription")
        .addStringOption(option =>
            option
                .setName("id")
                .setDescription("The inscription number or ID")
                .setRequired(true)
        ...
        if (communityStatut.toLowerCase() === "active") {
            ...
            if (botPowerStatut.toLowerCase() === "on") {
                ...
                if (member.roles.cache.has(communityMemberRoleId)) {
                    ...
                    const call = await axios.get("https://api.hiro.so/ordinals/v1/inscriptions/" + selectedID)
                    ...
                    const marketOverviewEmbed1 = new EmbedBuilder().setColor("#060A8F")
                        ...
                        .addFields(
                            ...
                            { name: "Inscription", value: "`" + selectedID.toLowerCase() + "`", inline: false },
                            { name: "Inscr. Number", value: "`#" + inscriptionNumber + "`", inline: true },
                            { name: "Sat. Rarity", value: "`" + inscriptionRarity + "`", inline: true },
