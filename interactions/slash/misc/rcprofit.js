                        ...
                        if (member.roles.cache.has(communityAdminRoleId)) {
                            ...
                            if (rcWalletsTable.length > 0) {
                                ...
                                const setwalletErrorEmbed = new EmbedBuilder().setColor("#060A8F")
                                    .setTitle(`No wallet`)
                                    .setDescription("Aura can't analyze the community's wallet data because you don't have any wallet registered in your community portfolio. Please use `/setwallet` to register a wallet in your portfolio then try again.")
