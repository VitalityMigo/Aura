                ...
                if (member.roles.cache.has(communityMemberRoleId)) {
                    ...
                    if (member.roles.cache.has(communityAdminRoleId) && authorId == "941039180262297701") {
                        ...
                        if (moduleChoice == "Bot Access") {
                            ...
                            //         { name: 'Links', value: "[documentation](https://aura-3.gitbook.io/aura) ∙ [twitter](https://twitter.com/AuraAnalytics) ∙ [discord](https://discord.gg/nMKzzfR6gx) ∙ [website](https://www.aurafinance.pro)", inline: false },
