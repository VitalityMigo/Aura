                ...
                if (member.roles.cache.has(communityMemberRoleId)) {
                    ...
                    if (member.roles.cache.has(communityAdminRoleId) && authorId == "941039180262297701") {
                        ...
                        if (moduleChoice == "Bot Access") {
                            ...
                            //         { name: 'Links', value: "[documentation](https://aura-3.gitbook.io/aura) ∙ [twitter](https://twitter.com/AuraAnalytics) ∙ [discord](https://discord.gg/nMKzzfR6gx) ∙ [website](https://cdn.discordapp.com/attachments/1108757872315219968/1122318373078958130/image.png)", inline: false },
                            ...
                            //         { name: ' ', value: " ", inline: false },
                            //         { name: 'How can I get access to Aura ?', value: "There are several ways to use Aura, both for communities and individual users. For individual users, go here : <#1108757700885622784>. For communities, you can send a message directly to our team or open a ticket. For more information, go [here](https://aura-3.gitbook.io/aura).", inline: false },
                            //         { name: ' ', value: " ", inline: false },
                            //         { name: 'What do I get by taking the monthly subscription ?', value: "Aura monthly subscription gives you access to the tool on the Aura server. In addition, you gain access to a community of active web3 traders and investors. We'll be adding more benefits as we go along. You can go here <#1108757530076774512> to get a quick overview of Aura or [here](https://aura-3.gitbook.io/aura) for the full presentation.", inline: false },
                            //         { name: ' ', value: " ", inline: false },
                            //         { name: "What is the future of Aura ?", value: "Our team is constantly working to improve Aura's functionality and operation. Our aim is to be highly responsive so that we can always adapt to market conditions.", inline: false },
                            //         { name: ' ', value: " ", inline: false },
